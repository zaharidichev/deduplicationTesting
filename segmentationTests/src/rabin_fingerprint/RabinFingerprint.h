 ...
 */
 void initWindow(rabinData* window, POLY_64 PT);
 ...
 */
 void precomputeTables(rabinData* fingerprintData);
 ...
 * removed
 */
POLY_64 popAByte(rabinData* data, BYTE byte, POLY_64 oldFingerprint, byteBuffer* buffer);
 ...
 */
INT_64 pushAByte(INT_64 oldFingerprint, rabinData* data, BYTE byte);
 ...
 * @return the updated fingerprint
 */
POLY_64 update(rabinData* data, BYTE m, POLY_64 fingerprint, byteBuffer* buffer);

inline void initWindow(rabinData* window, POLY_64 PT) {
	window->Irreducble_PT = PT; // set the internal variable to the irreducible poly
	precomputeTables(window);
}

inline void precomputeTables(rabinData* fingerprintData) {
...
inline POLY_64 popAByte(rabinData* data, BYTE byte, POLY_64 oldFingerprint, byteBuffer* buffer) {
	/*
...
inline INT_64 pushAByte(INT_64 oldFingerprint, rabinData* data, BYTE byte) {
...
inline POLY_64 update(rabinData* data, BYTE byte, POLY_64 oldFingerprint, byteBuffer* buffer) {
