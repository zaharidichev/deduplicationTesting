 ...
 */
void initBuffer(byteBuffer* buf);
 ...
 * @param buf pointer to the buffer
 */
void resetBuffer(byteBuffer* buf);
 ...
 */
BYTE push(BYTE b, byteBuffer* buf);

inline void initBuffer(byteBuffer* buf) {
...
inline void resetBuffer(byteBuffer* buf) {
	initBuffer(buf);
}

inline bool isFull(byteBuffer* buf) {
	/*
...
inline unsigned char push(BYTE b, byteBuffer* buf) {
